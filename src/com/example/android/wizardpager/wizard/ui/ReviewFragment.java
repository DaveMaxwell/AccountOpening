...
import com.example.android.wizardpager.ToDoActivity;
...
public class ReviewFragment extends ListFragment implements ModelCallbacks {
    ...
    private class ReviewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup container) {
           ...
           // ((TextView) rootView.findViewById(R.id.textNewToDo)).append(" " + reviewItem.getTitle());
           // ((TextView) rootView.findViewById(R.id.textNewToDo)).append(" " + value);
