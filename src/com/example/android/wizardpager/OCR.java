...
public class OCR extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//android.widget.ProgressBar bar = new android.widget.ProgressBar(getBaseContext());
		...
		//photoPath = "/sdcard/SmallPassportSize.jpg";
	...
	class Worker implements Runnable {
		...
		public void run() {
			try {
				...
				//String filePath = "/sdcard/SmallPassportSize.jpg";
				String filePath = "/sdcard/POI.png";
				
				String outputFile = "/sdcard/POIresult.txt";
...
/*		    	Intent intent = new Intent();
		        intent.setClass(OCR.this, Address.class);
		        OCR.this.startActivity(intent);*/
